data_catalog = {
  aceh_pintu_aceh: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/aceh_pintu_aceh.jpg",
  },
  bali_barong: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_bali_barong.jpg",
  },
  bali_merak: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/bali_merak.jpg",
  },
  dki_ondel_ondel: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_ondel-ondel.jpg",
  },
  jawa_barat_megamendung: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/jawa_barat_mega_mendung.jpg",
  },
  jawa_tengah_batik_lasem: {
    ...
    history:
      "Batik pesisir utara, terutama Lasem, merupakan hasil akulturasi budaya yang kaya akibat letak geografisnya sebagai pusat perdagangan maritim sejak abad ke-15. Percampuran budaya Jawa, Arab, Tionghoa, dan Eropa menghasilkan corak batik yang unik dan beragam. Orang-orang Tionghoa memainkan peran penting dalam industri batik Lasem, mulai dari produksi hingga distribusi. Mereka mengorganisir sistem produksi yang melibatkan banyak pembatik, terutama perempuan, dan mengimpor bahan baku seperti kain katun dan lilin dari berbagai wilayah.",
    link_shop: "https://www.tokopedia.com/search?st=&q=batik%20lasem",
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/jawa_tengah_batik_lasem.jpg",
  },
  jawa_timur_pring: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_jatim_pring.jpg",
  },
  kalimantan_barat_insang: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/kalimantan_barat_insang.jpg",
  },
  kalimantan_dayak: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_dayak2_kalimantan.jpg",
  },
  lampung_gajah: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/lampung_gajah.jpg",
  },
  madura_mataketeran: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/madura_mataketeran.jpg",
  },
  maluku_pala: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/maluku_pala.jpg",
  },
  ntb_lumbung: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_ntb_lumbung.jpg",
  },

  palembang_songket: {
    name: "Batik Songket Palembang",
    description:
      "Batik Songket Palembang terkenal dengan keindahan kain tenun yang digunakan sebagai dasar motif. Batik ini melambangkan kemewahan, status sosial, dan budaya tinggi masyarakat Palembang, dengan pola yang sering dihiasi benang emas untuk memberikan kesan elegan.",
    occasion:
      "Batik Songket cocok dikenakan pada acara formal seperti pernikahan adat, upacara keagamaan, atau perayaan budaya khas Sumatera Selatan.",
    history:
      "Batik Songket Palembang berakar dari tradisi keraton Kesultanan Palembang Darussalam pada abad ke-17. Songket awalnya hanya digunakan oleh keluarga bangsawan sebagai simbol status sosial dan kekayaan. Kombinasi teknik tenun songket dengan pewarnaan batik modern mulai berkembang pada abad ke-20 untuk melestarikan warisan budaya ini dalam bentuk yang lebih praktis.",
    link_shop:
      "https://www.tokopedia.com/search?st=&q=batik%20songket%20palembang",
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/palembang_songket.jpg",
  },
  ...
  papua_asmat: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/papua_asmat.jpg",
  },
  papua_cendrawasih: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/papua_cendrawasih.jpg",
  },
  papua_tifa: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/papua_tifa.jpg",
  },
  solo_parang: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/solo_parang.jpg",
  },
  solo_sidoluhur: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/solo_sidoluhur.jpg",
  },
  solo_sogan: {
    name: "Batik Solo Sogan",
    description:
      "Batik Solo Sogan terkenal dengan penggunaan warna coklat tua yang elegan dan kaya. Motifnya sering kali terinspirasi oleh alam dan flora yang dipadukan dengan ornamen yang berkelas.",
    occasion:
      "Batik Sogan cocok dikenakan dalam acara-acara formal atau perayaan penting yang mengedepankan keanggunan.",
    history:
      "Batik Solo Sogan berasal dari kerajaan Solo dan awalnya digunakan oleh keluarga kerajaan dan bangsawan. Motif ini simbol dari kemewahan dan kesan yang mendalam, dengan warna sogan yang terbuat dari bahan alami.",
    link_shop: "https://www.tokopedia.com/search?st=&q=batik%20solo%20sogan",
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/solo_sogan.jpg",
  },
  solo_truntum: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/solo_truntum.jpg",
  },
  sulawesi_selatan_lontara: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_sulawesi_selatan.jpg",
  },
  sumatera_barat_rumah_minang: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/sumatera_barat_rumah_minang.jpg",
  },
  ...
  sumatera_utara_boraspati: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/batik_boraspati.jpg",
  },
  yogyakarta_kawung: {
    ...
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/yogyakarta_kawung.jpg",
  },
  yogyakarta_sidomukti: {
    name: "Batik Sidomukti Yogyakarta",
    description:
      "Batik Sidomukti memiliki motif garis-garis yang saling bertautan dan membentuk pola geometris yang elegan. Motif ini melambangkan harapan untuk mencapai kebahagiaan dan kesejahteraan dalam hidup.",
    occasion:
      "Batik Sidomukti sering dipakai dalam acara pernikahan adat Jawa, upacara keagamaan, atau acara formal lainnya.",
    history:
      "Batik Sidomukti berasal dari tradisi keraton Yogyakarta dan sering digunakan oleh keluarga kerajaan dalam upacara penting. Motif ini melambangkan perjalanan menuju kebahagiaan yang abadi, dengan harapan hidup yang sejahtera.",
    link_shop:
      "https://www.tokopedia.com/search?st=&q=batik%20sidomukti%20yogyakarta",
    link_image:
      "https://storage.googleapis.com/jejakbatik-storage/catalog-assets/yogyakarta_sidomukti.jpg",
  },
};
